...
STATEMENT_PROFILES = (
    ...
    # ── Canadian banks (continued) ────────────────────────────────────────────
    StatementProfile(
        profile_id="bmo",
        display_name="BMO (Bank of Montreal)",
        detection_markers=("bank of montreal",),
        extra_noise_prefixes=(
            "bank of montreal",
    ...
    StatementProfile(
        profile_id="laurentian",
        display_name="Laurentian Bank",
        detection_markers=("banque laurentienne", "laurentian bank"),
        extra_noise_prefixes=(
            "banque laurentienne",
    ...
    StatementProfile(
        profile_id="atb",
        display_name="ATB Financial",
        detection_markers=("atb financial", "alberta treasury branches"),
        extra_noise_prefixes=(
            "atb financial",
    ...
    StatementProfile(
        ...
        detection_markers=("jpmorgan chase bank", "chase bank"),
        extra_noise_prefixes=(
            "jpmorgan chase bank",
            "chase bank",
            "checking account",
        ...
        extra_balance_markers=(
            ...
            "total withdrawals and deductions",
        ),
        balance_delta_type_inference=True,
    ),
    StatementProfile(
        ...
        detection_markers=("bank of america",),
        extra_noise_prefixes=(
            "bank of america",
            "bankofamerica.com",
            "account number",
    ...
    StatementProfile(
        profile_id="wells_fargo",
        display_name="Wells Fargo",
        detection_markers=("wells fargo bank", "wells fargo"),
        extra_noise_prefixes=(
            "wells fargo bank",
            "wellsfargo.com",
            "account number",
    ...
    StatementProfile(
        profile_id="capital_one",
        display_name="Capital One",
        detection_markers=("capital one",),
        extra_noise_prefixes=(
            "capital one",
            "capitalone.com",
            "account number ending in",
    ...
    StatementProfile(
        profile_id="citibank",
        display_name="Citibank / Citi",
        detection_markers=("citibank", "citi.com"),
        extra_noise_prefixes=(
            "citibank",
            "citi.com",
            "account number",
    ...
    StatementProfile(
        ...
        detection_markers=("u.s. bank national association", "usbank.com"),
        extra_noise_prefixes=(
    ...
    StatementProfile(
        profile_id="td_bank_us",
        display_name="TD Bank (US)",
        detection_markers=("td bank, n.a.", "america's most convenient bank"),
        extra_noise_prefixes=(
            "td bank, n.a.",
    ...
    StatementProfile(
        ...
        detection_markers=("american express", "americanexpress.com"),
        extra_noise_prefixes=(
            "american express",
            "americanexpress.com",
    ...
    StatementProfile(
        ...
        detection_markers=("discover bank", "discover.com"),
        extra_noise_prefixes=(
            "discover bank",
    ...
    StatementProfile(
        ...
        detection_markers=("pnc bank", "pnc.com"),
        extra_noise_prefixes=(
            "pnc bank",
            "pnc.com",
            "account number",
    ...
    StatementProfile(
        profile_id="navy_federal",
        display_name="Navy Federal Credit Union",
        detection_markers=("navy federal credit union", "navyfederal.org"),
        extra_noise_prefixes=(
