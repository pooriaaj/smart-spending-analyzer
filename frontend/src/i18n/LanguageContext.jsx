...
const translations = {
  en: {
    ...
    analytics: {
      ...
      transferIncomeHelper: "Excludes {amount} received as transfers",
      transferExpenseHelper: "Excludes {amount} sent as transfers or card payments",
      cashflowReviewTitle: "Transfers waiting on you",
      cashflowReviewDetail:
        "{count} transfer(s) are left out of income and spending until you say what they were.",
      cashflowReviewAction: "Review transfers",
    ...
    assistant: {
      ...
      freePlan: "Free plan",
      aiCoach: "AI Coach",
      ruleBasedActive: "Rule-based",
      upgradeCta: "Upgrade for AI coach",
      upgradeNudge:
        "Coach mode gives OpenAI-powered, super-smart answers. It is a premium feature.",
      switchToCoach: "Switch to Coach mode for AI-powered answers.",
    ...
    transactionForm: {
      ...
      savedIncome: "Saved: +${amount} income on {date}.",
      savedExpense: "Saved: -${amount} expense on {date}.",
      savedHint:
        "The list below is sorted newest first, so an older date may be on a later page. Clear the filters if you cannot find it.",
    },
    cashflowReview: {
      title: "What were these transfers?",
      intro:
        "Your bank prints the same words for a paycheque, a debt someone paid back, and money you moved between your own accounts. Rather than guess, we leave these out of your totals until you decide.",
      income: "I earned it",
      incomeHint: "Pay, a sale, a gift. Counts as income.",
      expense: "I spent it",
      expenseHint: "Rent, a bill, money given away. Counts as spending.",
      neutral: "Neither",
      neutralHint: "My own money moving, or a debt repaid. Counts as nothing.",
      undo: "Undo",
      empty: "Nothing is waiting. Every transfer has an answer.",
      loadFailed: "Could not load the transfers waiting for a decision.",
      saveFailed: "Could not save that choice.",
      savedIncome: "Counted as income.",
      savedExpense: "Counted as spending.",
      savedNeutral: "Left out of income and spending.",
      savedUndo: "Put back on the list.",
      close: "Done",
      showAnswered: "Show the ones I already answered",
      answeredAs: "You called this {role}",
      applyToSimilar: "Remember my answer for this person",
      applyToSimilarHint:
        "Applies the same answer to their other transfers, and to future ones, so you are not asked again.",
      groupHint: "{count} from {counterparty}",
      alsoApplied: "Also applied to {count} similar transfer(s).",
    },
    notFound: {
  ...
  fr: {
    ...
    analytics: {
      ...
      transferIncomeHelper: "Exclut {amount} reçus sous forme de virements",
      transferExpenseHelper: "Exclut {amount} envoyés en virements ou paiements de carte",
      cashflowReviewTitle: "Virements en attente de votre décision",
      cashflowReviewDetail:
        "{count} virement(s) sont exclus des revenus et des dépenses tant que vous n'avez pas indiqué ce qu'ils étaient.",
      cashflowReviewAction: "Examiner les virements",
    ...
    assistant: {
      ...
      aiCoach: "Coach IA",
      ruleBasedActive: "Basé sur des règles",
      upgradeCta: "Passer au coach IA",
      upgradeNudge:
        "Le mode Coach fournit des réponses ultra-intelligentes propulsées par OpenAI. C'est une fonctionnalité premium.",
      switchToCoach: "Passez en mode Coach pour des réponses propulsées par l'IA.",
    ...
    transactionForm: {
      ...
      confidence: "Confiance",
      matchedKeyword: "Mot-clé trouvé",
      accountRequired: "Veuillez choisir le compte auquel appartient cette transaction.",
      amountRequired: "Veuillez entrer un montant supérieur à zéro.",
      ...
      savedIncome: "Enregistré : +{amount} $ de revenu le {date}.",
      savedExpense: "Enregistré : -{amount} $ de dépense le {date}.",
      savedHint:
        "La liste ci-dessous est triée du plus récent au plus ancien : une date plus ancienne peut se trouver sur une page suivante. Effacez les filtres si vous ne la trouvez pas.",
    },
    cashflowReview: {
      title: "Qu'étaient ces virements ?",
      intro:
        "Votre banque emploie les mêmes mots pour une paie, une dette qu'on vous a remboursée et de l'argent déplacé entre vos propres comptes. Plutôt que de deviner, nous les excluons de vos totaux jusqu'à ce que vous décidiez.",
      income: "Je l'ai gagné",
      incomeHint: "Paie, vente, cadeau. Compté comme revenu.",
      expense: "Je l'ai dépensé",
      expenseHint: "Loyer, facture, argent donné. Compté comme dépense.",
      neutral: "Ni l'un ni l'autre",
      neutralHint: "Mon propre argent déplacé, ou une dette remboursée. Compté nulle part.",
      undo: "Annuler",
      empty: "Rien en attente. Chaque virement a une réponse.",
      loadFailed: "Impossible de charger les virements en attente de décision.",
      saveFailed: "Impossible d'enregistrer ce choix.",
      savedIncome: "Compté comme revenu.",
      savedExpense: "Compté comme dépense.",
      savedNeutral: "Exclu des revenus et des dépenses.",
      savedUndo: "Remis dans la liste.",
      close: "Terminé",
      showAnswered: "Afficher ceux auxquels j'ai déjà répondu",
      answeredAs: "Vous avez indiqué : {role}",
      applyToSimilar: "Retenir ma réponse pour cette personne",
      applyToSimilarHint:
        "Applique la même réponse à ses autres virements, et aux prochains, pour ne plus vous les redemander.",
      groupHint: "{count} de {counterparty}",
      alsoApplied: "Appliqué aussi à {count} virement(s) semblable(s).",
    },
    notFound: {
