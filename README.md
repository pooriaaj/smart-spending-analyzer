...
- Current focused frontend coverage includes API auth handling, protected route gates, account selector/account-scope behavior, login, registration, forgot/reset password, transaction form create/edit/category suggestion behavior, profile export, password visibility, and error helpers.
- GitHub workflows:
